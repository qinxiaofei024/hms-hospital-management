...
const trendData = {
    '5': {
        ...
        series: [
            {
                name: '医疗质量',
                data: [357.8, 365.8, 373.4, 374.2, 387.7]
            },
            {
                name: '运营效率',
                data: [222.7, 226.8, 230.6, 234.9, 228.8]
            },
            {
                name: '持续发展',
                data: [112.1, 114.5, 116.5, 117.9, 124.2]
            },
            {
                name: '满意度评价',
                data: [103.8, 104.6, 105.7, 106.7, 109.4]
            }
        ]
    },
    '3': {
        ...
        series: [
            {
                name: '医疗质量',
                data: [373.4, 374.2, 387.7]
            },
            {
                name: '运营效率',
                data: [230.6, 234.9, 228.8]
            },
            {
                name: '持续发展',
                data: [116.5, 117.9, 124.2]
            },
            {
                name: '满意度评价',
                data: [105.7, 106.7, 109.4]
            }
        ]
    },
    '1': {
