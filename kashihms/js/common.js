...
Common.Export = {
    ...
    ensureHtml2pdf: function() {
        return new Promise(function(resolve, reject) {
            ...
            Common.loadJS('https://cdn.jsdelivr.net/npm/html2pdf.js@0.9.3/dist/html2pdf.bundle.min.js', function(){
    ...
    ensureXLSX: function() {
        return new Promise(function(resolve, reject) {
            ...
            Common.loadJS('https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js', function(){
