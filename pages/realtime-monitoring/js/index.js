var siz2;
/*数据初始化-开始*/
// 初始化广东地图 - 使用ECharts geo组件
var guangdongChart = echarts.init(document.getElementById('map1'));
guangdongChart.setOption(guangdongMapOption);
//中间科室切换（默认显示中国地图）
